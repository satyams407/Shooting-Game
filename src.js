   ...
   function myspacegame(){  
	  ...
	  //creating instance of bullet
		...
		function Enemy(I) {
          ...
          else if(gameScore>500 && gameScore<1000) I.yVelocity = 4;
		  else if(gameScore>1000 && gameScore<2000) I.yVelocity = 16;
		  else if(gameScore>2000 && gameScore<4000) I.yVelocity =24;
		  else I.yVelocity=36;
