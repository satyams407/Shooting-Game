   ...
   function myspacegame(){  
	  ...
	  //creating instance of bullet
		...
		function Enemy(I) {
		  ...
		  else if(gameScore>=1000 && gameScore<1500) I.yVelocity = 6;
		  else I.yVelocity=10;
    ...
    //function for special type of enemy
		function SpecialEnemy(I) {
          ...
          I.update = function() {
            ...
            I.xVelocity = .7 * Math.sin(I.age * Math.PI / 64);
        ...
        function update() {
         ...
         //Generation of Special type of enemy  		
		if((gameScore%100)==0 && gameScore>=100 ){
			  if(Math.random() < .06) specialenemies.push(SpecialEnemy()); 
		 }
		
		  //increasing frequency of enemies when game level got higher
          if(gameScore>1250)
		  {		
            if(Math.random() < .03) 
		    {
	   ...
	   //function to display life of player 
	   function drawlife(){
	    canvas.font = "14px Verdana";
        canvas.fillStyle = "#f00";
        canvas.fillText("Remaining Lifes: " + life, 8, 20);
	   }
       
	   //function to draw levels of game
 	   function drawlevel(){
